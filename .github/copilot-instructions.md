...
- [⚠️ CRITICAL: RESEARCH BEFORE IMPLEMENTATION](#critical-research-before-implementation)
- [🗺️ Documentation Map (START HERE)](#documentation-map-start-here)
...
_This file follows GitHub's best practices for Copilot instructions._
_For questions or clarifications, refer to `jobcard.md` for recent change context._
